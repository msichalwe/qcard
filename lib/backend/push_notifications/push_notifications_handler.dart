...
class _PushNotificationsHandlerState extends State<PushNotificationsHandler> {
  ...
  Widget build(BuildContext context) => _loading
      ? Container(
          ...
          child: Center(
            child: Image.asset(
              'assets/images/QuiCkCaRd_free-file.png',
              width: 200,
              height: 200,
              fit: BoxFit.contain,
            ),
...
final parametersBuilderMap =
  ...
  'scanPage': ParameterData.none(),
  'account': ParameterData.none(),
  'scans': ParameterData.none(),
  'profilepage_main': (data) async => ParameterData(
        allParams: {
          'userId': getParameter<DocumentReference>(data, 'userId'),
          'usermainId': getParameter<String>(data, 'usermainId'),
        },
      ),
